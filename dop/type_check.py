...
далее. Если данное условие не выполняется, должно быть возбуждено
...
необходимый декоратор @type_check , но не код, вызывающий его."""


class type_check:
    def __init__(self, types: list[Any]) -> None:
        self.types = types

    def __call__(self, func: Callable) -> Callable:
        @wraps(func)
        def wrapper(*args, **kwargs) -> Any:
            length = min(len(self.types), len(args))
